...
class DeepLTranslatorTest extends TestCase
{
    ...
    public function it_translates_correctly(){
        $deepl = $this->prophesize(SourceDeeplTranslator::class);
        $deepl->translateText('Welcome', 'en', 'fr')->shouldBeCalled()->willReturn([['text' => 'Bienvenue']]);
    ...
    public function it_returns_null_and_logs_if_an_error_is_thrown(){
        $deepl = $this->prophesize(SourceDeeplTranslator::class);
        $deepl->translateText('Welcome', Argument::any(), Argument::any())->shouldBeCalled()->willThrow(new DeepLException('Test Message'));
    ...
    public function it_returns_an_array_from_translateMany(){
        $deepl = $this->prophesize(SourceDeeplTranslator::class);
        $deepl->translateText(['Welcome', 'thank you'], 'en', 'fr')->shouldBeCalled()->willReturn([['text' => 'bienvenue'], ['text' => 'merci']]);
